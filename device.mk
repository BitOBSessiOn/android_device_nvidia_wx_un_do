...
$(call inherit-product-if-exists, vendor/nvidia/wx_un_do/wx_un_do-vendor.mk)

## overlay
DEVICE_PACKAGE_OVERLAYS += device/nvidia/wx_un_do/overlay
...
#SELinux
BOARD_SEPOLICY_DIRS += device/nvidia/wx_un_do/sepolicy/
